			...
			<section class="main-section">
				...
				<div class="row mypage-card-container">
					...
					<div class="mypage-card">
						<h3>회원 관리</h3>
						<div><i class="bi bi-people" style="font-size: 10rem; color: #FAB350;"></i></div>
						<div>
							<p>회원 정보와 권한을</p>
							<p>관리할 수 있습니다.</p>
						</div>
					...
					<div class="mypage-card">
						<h3>강좌 관리</h3>
						<div><i class="bi bi-collection-play" style="font-size: 10rem; color: #FAB350;"></i></div>
						<div>
							<p>전체 강좌와 카테고리를</p>
							<p>관리할 수 있습니다.</p>
						</div>
					...
					<div class="mypage-card">
						<h3>결제 관리</h3>
						<div><i class="bi bi-cash-coin" style="font-size: 10rem; color: #FAB350;"></i></div>
						<div>
							<p>결제와 환불 현황을</p>
							<p>관리할 수 있습니다.</p>
						</div>
					...
					<div class="mypage-card">
						<h3>게시판 관리</h3>
						<div><i class="bi bi-layout-text-window-reverse" style="font-size: 10rem; color: #FAB350;"></i></div>
						<div>
							<p>게시판과 신고글을</p>
							<p>관리할 수 있습니다.</p>
						</div>
