...
@WebServlet(name="adminPageInfoUpdate", urlPatterns="/admin/manage/site/save")
public class AdminManageSiteSaveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    // TextNormalizer 인스턴스 생성
    private final TextNormalizer textNormalizer = new TextNormalizer();
       
    public AdminManageSiteSaveServlet() {
        super();
    }
